...
class DiffusionModel:
    def __init__(self, t_steps=1000, epochs=10):
        ...
        self.betas = torch.linspace(self.beta_start, self.beta_end, self.t_steps)
    ...
    def add_noise_one_step(self, x, t):
        ...
        # TODO: should i return (and therefore predict) noise or scaled_noise?
    ...
    def denoise_one_step(self, x, t):
        ...
        return c1 * (x - c2 * noise_pred) + torch.sqrt(beta) * torch.randn_like(x)
        ...
        return torchvision.transforms.Compose(
            [
                ...
                torchvision.transforms.Normalize(
                    (0.485, 0.456, 0.406), (0.23, 0.23, 0.23)
                ),
            ]
        )
